...
excerpt: "In [part 1](http://martinmicunda.com/2015/04/10/build-ionic-photo-gallery-app-I/) of this series I showed you how to prepare development environment with Vagrant and Ansible. In this second post we gonna build back-end code with Node.js, MongoDB and Redis for our `ionic-photo-gallery` app."
...
I still prefer to have one config file for my environment variables in my app as abstraction layer or at least defined the default values.
...
###Authentication
First we need to create local passport strategy but if you want to you can add more strategies e.g. facebook, google.
...
Token controller is responsible for creating, deleting and verify token:
...
Authentication controller has dependency on `toke.controller.js` and it use in `authentication.routes.js` and keep basic functionality like signin, signout, signup and check if API request is authenticated:
...
User module
###Image
The image module is really simple
...
##Conclusion
This post was quite long but I want you to have better understanding how back-end code works before we start developing ionic app in part 3. I would suggest you to keep eye on [MEAN.JS branch 4](https://github.com/meanjs/mean/tree/0.4.0) as cool things happening there.
